...
<div id="main">				          
    ...
    <p align="center" style="font-size: 20px; color: #9000CC">إضافة قسم جديد  </p>


    <form id="formID" class="monForm" action="<?php echo base_url(); ?>admin/creerClasse" method="post">
              <fieldset>    
                <legend>إضافة قسم جديد :
                </legend> 
