    ...
    <div id="main">
        ...
        <div id="tabs">
            <ul>
                ...
                <li><a href="#tabs-2">كتابة جدول الحصص</a></li>
                <li><a href="#tabs-3">ملء دفتر النصوص</a></li>
                <li><a href="#tabs-4">مشاهدة - طباعة دفتر النصوص</a></li>
            ...
            <div id="tabs-2">
                <?php $this->load->view('user/afficherEmploi'); ?>
            </div>
            <div id="tabs-3">
            ...
            <div id="tabs-5">
                <?php $this->load->view('user/afficherContact');?>
            </div>
        </div>
